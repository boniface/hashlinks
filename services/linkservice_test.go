...
func TestGeLinksFromFeeds(t *testing.T) {
	...
	feed1 := domain.Feed{"ZA", "NT", "1", "None", "http://www.daily-mail.co.zm/feed/", "RSS"}
	...
	feeds := []domain.Feed{feed, feed1, feed2, feed3, feed4, feed5, feed6, feed, feed8, feed9, feed10, feed11}
